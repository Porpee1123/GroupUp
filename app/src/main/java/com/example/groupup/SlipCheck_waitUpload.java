...
Extend_MyHelper.checkInternetLost(this);
    ...
    public void getSlipCheck() {
        ...
        new CountDownTimer(500, 500) {
            ...
            public void onFinish() {
                Log.d("slipUpload","12346 : "+MyArrList.toString()) ;
                SlipCheck_waitCheck.sAdap = new SimpleAdapter(SlipCheck_waitUpload.this, MyArrList, R.layout.activity_slip_check,
                        new String[]{"events_name", "states_name"}, new int[]{R.id.rowTextViewName, R.id.rowTextViewTag});
    ...
    public void getSlipFinish() {
        ...
        new CountDownTimer(500, 500) {
            ...
            public void onFinish() {
                Log.d("slipUpload","12346 : "+MyArrList.toString()) ;
                SlipCheck_finish.sAdap = new SimpleAdapter(SlipCheck_waitUpload.this, MyArrList, R.layout.activity_slip_finish,
                        new String[]{"events_name", "states_name"}, new int[]{R.id.rowTextViewName, R.id.rowTextViewTag});
