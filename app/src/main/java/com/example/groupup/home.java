        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                sAdap = new SimpleAdapter(home.this, MyArrList, R.layout.activity_column,
                        new String[] {"uid", "name", "email", "photo"}, new int[] {R.id.col_trans_id, R.id.col_name, R.id.col_msg, R.id.col_amt});
                ...
                final AlertDialog.Builder viewDetail = new AlertDialog.Builder(home.this);
                    ...
                    public void onItemClick(AdapterView<?> myAdapter, View myView, int position, long mylng) {
                        String sTransID = MyArrList.get(position).get("uid").toString();
